package com.jesen.sample_server.handle;
...
public class ClientHandler {
    ...
    public void exit() {
        ...
        System.out.println("客户端【" + clientInfo + "】已退出");
    }
    ...
    class ClientWriteHandler {
        ...
        class WriteRunnable implements Runnable {
            ...
            public void run() {
                ...
                byteBuffer.flip(); // 反转操作 把指针回到开始位置
                while (!done && byteBuffer.hasRemaining()) { // Buffer如果有数据
                    try {
                        // 发送 len=0合法
